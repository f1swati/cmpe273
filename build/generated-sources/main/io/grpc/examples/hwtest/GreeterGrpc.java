...
public class GreeterGrpc {
  ...
  private static final io.grpc.stub.Method<io.grpc.examples.hwtest.HelloRequest,
      io.grpc.examples.hwtest.HelloResponse> METHOD_SAY_HELLO =
      io.grpc.stub.Method.create(
          io.grpc.MethodType.UNARY, "SayHello",
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.hwtest.HelloRequest.PARSER),
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.hwtest.HelloResponse.PARSER));
  ...
  public static class GreeterServiceDescriptor extends
    ...
    public final io.grpc.MethodDescriptor<io.grpc.examples.hwtest.HelloRequest,
        io.grpc.examples.hwtest.HelloResponse> sayHello;

    private GreeterServiceDescriptor() {
      sayHello = createMethodDescriptor(
          "grpc.example.hwtest.Greeter", METHOD_SAY_HELLO);
    }

    @SuppressWarnings("unchecked")
    private GreeterServiceDescriptor(
        java.util.Map<java.lang.String, io.grpc.MethodDescriptor<?, ?>> methodMap) {
      sayHello = (io.grpc.MethodDescriptor<io.grpc.examples.hwtest.HelloRequest,
          io.grpc.examples.hwtest.HelloResponse>) methodMap.get(
  ...
  public static interface Greeter {
    ...
    public void sayHello(io.grpc.examples.hwtest.HelloRequest request,
        io.grpc.stub.StreamObserver<io.grpc.examples.hwtest.HelloResponse> responseObserver);
  }

  public static interface GreeterBlockingClient {

    public io.grpc.examples.hwtest.HelloResponse sayHello(io.grpc.examples.hwtest.HelloRequest request);
  }

  public static interface GreeterFutureClient {

    public com.google.common.util.concurrent.ListenableFuture<io.grpc.examples.hwtest.HelloResponse> sayHello(
        io.grpc.examples.hwtest.HelloRequest request);
  }
  ...
  public static io.grpc.ServerServiceDefinition bindService(
    ...
    return io.grpc.ServerServiceDefinition.builder("grpc.example.hwtest.Greeter")
      .addMethod(createMethodDefinition(
          METHOD_SAY_HELLO,
          asyncUnaryRequestCall(
            new io.grpc.stub.ServerCalls.UnaryRequestMethod<
                io.grpc.examples.hwtest.HelloRequest,
                io.grpc.examples.hwtest.HelloResponse>() {
              @java.lang.Override
              public void invoke(
                  io.grpc.examples.hwtest.HelloRequest request,
                  io.grpc.stub.StreamObserver<io.grpc.examples.hwtest.HelloResponse> responseObserver) {
